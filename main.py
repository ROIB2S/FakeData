...
if __name__ == "__main__":
    ...
    print(getTRANSFER())
    print(getrow())
    sample = int(input("Enter Number of Sample Files (up to 50,000 entires each) (-1 for none):"))
    print(createsamples(sample,50000))
    production = int(input("Enter Number of Production Files (up to 250,000 entries each) (-1 for none):"))
